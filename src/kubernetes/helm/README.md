...
| `monolith.image.repository`    | Monolith image repository                       | `ghcr.io/mivallion/architecture-pro-cinemaabyss/monolith` |
...
| `proxyService.image.repository`| Proxy service image repository                  | `ghcr.io/mivallion/architecture-pro-cinemaabyss/proxy-service` |
...
| `moviesService.image.repository`| Movies service image repository                | `ghcr.io/mivallion/architecture-pro-cinemaabyss/movies-service` |
...
| `eventsService.image.repository`| Events service image repository                | `ghcr.io/mivallion/architecture-pro-cinemaabyss/events-service` |
